...
namespace IterationStatements
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //TODO - Create a variable of type int and name it "num" - DONE!
            //TODO - Initialize the variable with a value of 0 - DONE!
            int num = 0;


            //TODO - Create a do-while loop using the existing brackets as a template. - DONE!
            // The existing brackets are placeholders for your loop code. - DONE!
            // Inside this loop: - DONE!
            // a) Increment "num" by 1 - DONE!
            // b) Then add "num" to the collection "numbers" - DONE!
            //    Hint: Use "numbers.Add(num);" to add the current value of "num" to the list. - DONE!
            do
            {
                // Your code goes here
                num++;
            ...
            //TODO - Continue the loop while "num" is less than 100 - DONE!
